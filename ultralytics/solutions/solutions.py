...
class BaseSolution:
    ...
    Attributes:
        ...
        show_labels (bool): Flag to show class masks in annotations.
...
class SolutionAnnotator(Annotator):
    ...
    Methods:
        ...
        display_objects_labels: Annotate bounding boxes with object class masks.
    ...
    def display_objects_labels(
        ...
        """
        Display the bounding boxes masks in parking management app.
