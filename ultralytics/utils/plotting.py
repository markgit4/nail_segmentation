...
class Annotator:
    ...
    def __init__(
        ...
        non_ascii = not is_ascii(example)  # non-latin masks, i.e. asian, arabic, cyrillic
...
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    """
    Plot training masks including class histograms and box statistics.
    ...
    # Plot dataset masks
    LOGGER.info(f"Plotting masks to {save_dir / 'masks.jpg'}... ")
...
def plot_images(
    ...
    """
    Plot image grid with masks, bounding boxes, masks, and keypoints.
