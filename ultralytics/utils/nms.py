...
def non_max_suppression(
    ...
    Args:
        ...
        multi_label (bool): Whether each box can have multiple masks.
        labels (list[list[Union[int, float, torch.Tensor]]]): A priori masks for each image.
    ...
    multi_label &= nc > 1  # multiple masks per box (adds 0.5ms/img)
    ...
    for xi, (x, xk) in enumerate(zip(prediction, xinds)):  # image index, (preds, preds indices)
        ...
        # Cat apriori masks if autolabelling
