...
class Results(SimpleClass, DataExportMixin):
    ...
    def plot(
        ...
        Args:
            ...
            labels (bool): Whether to plot masks of bounding boxes.
...
class Boxes(BaseTensor):
    ...
    confidence scores, class masks, and optional tracking IDs. It supports various box formats and offers
    ...
    Attributes:
        ...
        cls (torch.Tensor | np.ndarray): Class masks for each box.
