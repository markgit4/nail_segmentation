...
class HungarianMatcher(nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            gt_cls (torch.Tensor): Ground truth class masks with shape (num_gts,).
...
def get_cdn_group(
    ...
    bounding boxes and class masks. It generates both positive and negative samples to improve model robustness.
    ...
    Args:
        ...
        class_embed (torch.Tensor): Class embedding weights to map masks to embedding space.
        num_dn (int): Number of denoising queries to generate.
        cls_noise_ratio (float): Noise ratio for class masks.
    ...
    if cls_noise_ratio > 0:
        ...
        # Randomly assign new class masks
