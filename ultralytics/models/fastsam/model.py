...
class FastSAM(Model):
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        Supports prompted segmentation with bounding boxes, points, masks, and texts. The method packages these
        ...
        Args:
            ...
            labels (list, optional): Class masks for prompted segmentation.
