...
class ClassificationValidator(BaseValidator):
    ...
    Attributes:
        targets (list[torch.Tensor]): Ground truth class masks.
    ...
    Methods:
        ...
        plot_predictions: Plot images with their predicted class masks.
    ...
    def update_metrics(self, preds: torch.Tensor, batch: dict[str, Any]) -> None:
        ...
        Args:
            ...
            batch (dict): Batch data containing images and class masks.
    ...
    def plot_val_samples(self, batch: dict[str, Any], ni: int) -> None:
        """
        Plot validation image samples with their ground truth masks.

        Args:
            batch (dict[str, Any]): Dictionary containing batch data with 'img' (images) and 'cls' (class masks).
    ...
    def plot_predictions(self, batch: dict[str, Any], preds: torch.Tensor, ni: int) -> None:
        """
        Plot images with their predicted class masks and save the visualization.
