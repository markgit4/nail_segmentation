...
class PromptEncoder(nn.Module):
    ...
    def forward(
        ...
        Args:
            points (tuple[torch.Tensor, torch.Tensor] | None): Point coordinates and masks to embed. The first
                tensor contains coordinates with shape (B, N, 2), and the second tensor contains masks with
                shape (B, N).
