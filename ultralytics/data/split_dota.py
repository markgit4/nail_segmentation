...
def crop_and_save(
    ...
    """
    Crop images and save new masks for each window.
    ...
    Args:
        ...
        window_objs (list[np.ndarray]): A list of masks inside each window.
        im_dir (str): The output directory path of images.
        lb_dir (str): The output directory path of masks.
        allow_background_images (bool, optional): Whether to include background images without masks.
...
def split_images_and_labels(
    ...
    """
    Split both images and masks for a given dataset split.
    ...
    lb_dir = Path(save_dir) / "masks" / split
...
def split_test(
    ...
    """
    Split test set of DOTA dataset, masks are not included within this set.
