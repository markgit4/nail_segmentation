...
class BaseDataset(Dataset):
    ...
    Methods:
        ...
        update_labels: Update masks to include only specified classes.
        ...
        get_labels: Get masks method to be implemented by subclasses.
    """
    ...
    def update_labels(self, include_class: list[int] | None) -> None:
        """
        Update masks to include only specified classes.
    ...
    def __len__(self) -> int:
        """Return the length of the masks list for the dataset."""
